              ...
              <article class="p-feed-post">
                ...
                <figure class="p-feed-post__thumb">
                  <img src="<?php echo esc_url( $thumbnail_url ); ?>"
                    srcset="<?php echo esc_url( $thumbnail_url_2x ); ?>" width="240" height="160" alt="">
                </figure>

                <time class="p-feed-post__time" datetime="<?php echo esc_attr( $datetime ); ?>"><?php the_time('Y.m.d'); ?></time>
